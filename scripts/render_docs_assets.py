...
def render_detached():
    ...
    rounded(d, (130, 320, 1470, 430), 36, (231, 246, 235), (112, 132, 122), 3)
    paste_icon(base, (170, 348, 222, 400))
    text(d, (250, 362), "Akku 88%", INK, F["menu"])
    text(d, (455, 362), "↓", GREEN_BRIGHT, F["menu"])
    text(d, (510, 362), "☀ PV 496 W", (168, 101, 0), F["menu"])
    text(d, (780, 362), "⌂ Hauslast 352 W", (18, 115, 219), F["menu"])
    text(d, (1120, 362), "Netz -86 W", GREEN, F["menu"])
    text(d, (1388, 362), "×", MUTED, F["h3"])
