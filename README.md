...
- Hinweis / Note: Arabisch ist derzeit nicht enthalten, weil eine hochwertige arabische Fassung neben der Uebersetzung eine vollstaendig gepruefte Rechts-nach-links-Darstellung benoetigt. / Arabic is not currently included because a high-quality Arabic version requires a fully verified right-to-left layout in addition to translated text.
...
Aktuelle Version / Current version: `0.6.1`
...
unzip outputs/SolixBar-0.6.1-macOS-arm64.zip -d outputs
